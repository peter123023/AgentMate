...
[![Version](https://img.shields.io/github/v/release/farion1231/model-board?color=blue&label=version)](https://github.com/farion1231/model-board/releases)
[![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-lightgrey.svg)](https://github.com/farion1231/model-board/releases)
[![Built with Tauri](https://img.shields.io/badge/built%20with-Tauri%202-orange.svg)](https://tauri.app/)
[![Downloads](https://img.shields.io/github/downloads/farion1231/model-board/total)](https://github.com/farion1231/model-board/releases/latest)

<a href="https://trendshift.io/repositories/15372" target="_blank"><img src="https://trendshift.io/api/badge/repositories/15372" alt="farion1231%2Fmodel-board | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
<a href="https://www.star-history.com/#peter123023/llm-switch&Date"><picture><source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/badge?repo=peter123023/llm-switch&theme=dark" /><img alt="Star History Rank" src="https://api.star-history.com/badge?repo=peter123023/llm-switch" width="196" height="55" /></picture></a>

### 🌐 Die einzige offizielle Website: **[modelboard.io](https://modelboard.io)**
...
> **ModelBoard** basiert auf [farion1231](https://github.com/farion1231)s [CC Switch](https://github.com/farion1231/cc-switch) (dieses Repository ist ein Fork davon). Wir danken dem ursprünglichen Autor zutiefst für die Entwicklung eines so leistungsstarken und gut strukturierten Werkzeugs — ModelBoard wurde auf dem soliden Fundament von CC Switch ermöglicht.
...
- **Deep Link** (`modelboard://`) — Importieren Sie Anbieter, MCP-Server, Prompts und Skills per URL
...
<details>
<summary><strong>Welche KI-Werkzeuge unterstützt ModelBoard?</strong></summary>

ModelBoard unterstützt acht Werkzeuge: **Claude Code**, **Claude Desktop**, **Codex**, **Gemini CLI**, **Grok Build**, **OpenCode**, **OpenClaw** und **Hermes**. Jedes Werkzeug verfügt über dedizierte Anbieter-Presets und Konfigurationsverwaltung.
...
ModelBoard für macOS ist von Apple code-signiert und notarisiert. Sie können es direkt herunterladen und installieren — es sind keine zusätzlichen Schritte erforderlich. Wir empfehlen die Verwendung des `.dmg`-Installationsprogramms.
...
- **Datenbank**: `~/.model-board/model-board.db` (SQLite — Anbieter, MCP, Prompts, Skills)
- **Lokale Einstellungen**: `~/.model-board/settings.json` (gerätebezogene UI-Einstellungen)
- **Backups**: `~/.model-board/backups/` (automatisch rotiert, behält die 10 neuesten)
- **Skills**: `~/.model-board/skills/` (standardmäßig per Symlink mit den entsprechenden Apps verbunden)
- **Skill-Backups**: `~/.model-board/skill-backups/` (vor der Deinstallation automatisch erstellt, behält die 20 neuesten)
...
> **Hinweis**: ModelBoard für macOS ist von Apple code-signiert und notarisiert. Sie können es direkt installieren und öffnen.
...
- **SSOT** (Single Source of Truth): Alle Daten werden in `~/.model-board/model-board.db` (SQLite) gespeichert
