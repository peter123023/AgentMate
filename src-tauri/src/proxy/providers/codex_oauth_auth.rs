...
/// User-Agent
const CODEX_USER_AGENT: &str = "agentmate-codex-oauth";
...
struct CodexAccountData {
    ...
    /// agentmate 都可能轮换 refresh_token 时拒绝从 live 采纳更旧的一代。
    #[serde(default)]
...
impl CodexOAuthManager {
    ...
    /// CLI does not participate in agentmate's switch lock and may refresh in
