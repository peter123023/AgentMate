...
/**
 * 概览图标：取自 Heroicons（squares-2x2，圆角宫格），经 Iconify 获取后内联。
 * 相比 lucide 的 LayoutDashboard，四格圆角更大、留白更舒展，暗色侧栏下更精致。
 * 单色线性风格，跟随 currentColor，与相邻的「设置」齿轮保持视觉一致。
 */
export function OverviewIcon({ size = 18, className }: OverviewIconProps) {
  return (
    <svg
      width={size}
      height={size}
