...
ModelBoard provides rich icon customization features:
...
This ensures ModelBoard and CLI tool configurations stay in sync.
...
When adding a provider, ModelBoard automatically extracts endpoint URLs from the configuration.
