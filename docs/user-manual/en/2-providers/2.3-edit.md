...
AgentMate provides rich icon customization features:
...
This ensures AgentMate and CLI tool configurations stay in sync.
...
When adding a provider, AgentMate automatically extracts endpoint URLs from the configuration.
