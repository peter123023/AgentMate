...
2. ModelBoard updates the configuration file
...
1. Right-click the ModelBoard icon in the system tray
...
When switching providers, ModelBoard modifies the following files:
