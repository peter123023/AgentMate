...
2. AgentMate updates the configuration file
...
1. Right-click the AgentMate icon in the system tray
...
When switching providers, AgentMate modifies the following files:
