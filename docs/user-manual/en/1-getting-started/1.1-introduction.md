...
AgentMate is a cross-platform desktop application designed for developers who use AI tools. It helps you centrally manage configurations for **Claude Code**, **Claude Desktop**, **Codex**, **Gemini CLI**, **OpenCode**, **OpenClaw**, and **Hermes**.
...
AgentMate solves these problems through a unified interface.
...
AgentMate is built with a modern technology stack:
