...
Only download AgentMate from **[agentmate.app](https://github.com/peter123023/llm-switch)**, **[GitHub Releases](https://github.com/peter123023/llm-switch/releases)**, or the project source repository. Any "AgentMate" site or client that asks for payment, top-ups, or login credentials is not official.
...
The CLI tools managed by AgentMate (Claude Code, Codex, Gemini CLI) require a Node.js environment.
...
1. Visit the [Releases page](https://github.com/peter123023/llm-switch/releases)
...
2. Open the DMG, or extract the zip to get `AgentMate.app`
3. Drag it to the Applications folder

### Signed and Notarized

AgentMate for macOS is signed and notarized by Apple. You can install and open it directly — no extra steps needed.
...
After installation, launch AgentMate:

1. The app window displays correctly
2. A AgentMate icon appears in the system tray
3. The app switcher shows enabled managed apps, and you can switch to the target app panel

## Auto Update

AgentMate includes built-in auto-update functionality:
...
```bash
# Debian/Ubuntu
sudo apt remove agentmate

# ArchLinux
paru -R agentmate-bin
```
