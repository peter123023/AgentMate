...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (ModelBoard)
...
After starting the proxy and enabling app takeover, ModelBoard modifies app configurations:
...
When stopping the proxy, ModelBoard will:
