...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (AgentMate)
...
After starting the proxy and enabling app takeover, AgentMate modifies app configurations:
...
When stopping the proxy, AgentMate will:
